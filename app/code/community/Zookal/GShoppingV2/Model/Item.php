...
class Zookal_GShoppingV2_Model_Item extends Mage_Core_Model_Abstract
{
     ...
     *
     * @var Zookal_GShoppingV2_Model_Service_Item
     */
    ...
    public function getServiceItem()
    {
        if (is_null($this->_serviceItem)) {
            $this->_serviceItem = Mage::getModel('gshoppingv2/service_item')
     ...
     *
     * @param Zookal_GShoppingV2_Model_Service_Item $service
     *
     * @return Zookal_GShoppingV2_Model_Item
     */
    ...
    {
        return Mage::getSingleton('gshoppingv2/config')->getTargetCountry($this->getStoreId());
    }
    ...
    public function getType()
    {
        ...
        $type = Mage::getModel('gshoppingv2/type')
