 ...
 */
class BlueVisionTec_GoogleShoppingApi_Model_Attribute_ImageLink
    extends BlueVisionTec_GoogleShoppingApi_Model_Attribute_Default
{
    ...
    {
        $sp = $this->_dispatch('bluevisiontec_googleshoppingapi_attribute_imagelink', $product, $shoppingProduct);
        if ($sp !== null) {
            return $sp;
        }
