 ...
 */
class BlueVisionTec_GoogleShoppingApi_Model_Attribute_GoogleProductCategory
    extends BlueVisionTec_GoogleShoppingApi_Model_Attribute_Default
{
    ...
    {
        $sp = $this->_dispatch('bluevisiontec_googleshoppingapi_attribute_googleproductcategory', $product,
            $shoppingProduct);
        if ($sp !== null) {
            return $sp;
        }
