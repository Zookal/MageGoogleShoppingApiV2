 ...
 */
class BlueVisionTec_GoogleShoppingApi_Model_Attribute_Default
    extends BlueVisionTec_GoogleShoppingApi_Model_Attribute
{
    /**
    ...
    {
        $sp = $this->_dispatch('bluevisiontec_googleshoppingapi_attribute_default', $product, $shoppingProduct);
        if ($sp !== null) {
            return $sp;
        }
