 ...
 */
class BlueVisionTec_GoogleShoppingApi_Model_Attribute_TargetCountry
    extends BlueVisionTec_GoogleShoppingApi_Model_Attribute_Default
{
    ...
    {
        $sp = $this->_dispatch('bluevisiontec_googleshoppingapi_attribute_targetcountry', $product, $shoppingProduct);
        if ($sp !== null) {
            return $sp;
        }
