 ...
 */
class BlueVisionTec_GoogleShoppingApi_Model_Attribute_Content
    extends BlueVisionTec_GoogleShoppingApi_Model_Attribute_Default
{
    ...
    {
        $sp = $this->_dispatch('bluevisiontec_googleshoppingapi_attribute_content', $product, $shoppingProduct);
        if ($sp !== null) {
            return $sp;
        }
