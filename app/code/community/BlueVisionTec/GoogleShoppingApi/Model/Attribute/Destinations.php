 ...
 */
class BlueVisionTec_GoogleShoppingApi_Model_Attribute_Destinations
    extends BlueVisionTec_GoogleShoppingApi_Model_Attribute_Default
{
    ...
    {
        $sp = $this->_dispatch('bluevisiontec_googleshoppingapi_attribute_destinations', $product, $shoppingProduct);
        if ($sp !== null) {
            return $sp;
        }
