 ...
 */
class BlueVisionTec_GoogleShoppingApi_Model_Attribute_Quantity
    extends BlueVisionTec_GoogleShoppingApi_Model_Attribute_Default
{
    ...
    {
        $sp = $this->_dispatch('bluevisiontec_googleshoppingapi_attribute_quantity', $product, $shoppingProduct);
        if ($sp !== null) {
            return $sp;
        }
