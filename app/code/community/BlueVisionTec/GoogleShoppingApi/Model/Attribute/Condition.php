 ...
 */
class BlueVisionTec_GoogleShoppingApi_Model_Attribute_Condition
    extends BlueVisionTec_GoogleShoppingApi_Model_Attribute_Default
{
    ...
    {
        $sp = $this->_dispatch('bluevisiontec_googleshoppingapi_attribute_condition', $product, $shoppingProduct);
        if ($sp !== null) {
            return $sp;
        }
